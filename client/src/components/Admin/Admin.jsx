...
function Admin() {
  ...
  useEffect(() => {
    ...
    // Sort data
    filtered.sort((a, b) => {
      const aValue = sortBy === 'name' ? a.username : a.email;
      const bValue = sortBy === 'name' ? b.username : b.email;
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center space-x-3">
                            <div className={`w-10 h-10 rounded-full ${getRandomColor(item.username)} flex items-center justify-center font-bold text-sm text-white shadow-lg`}>
                        ...
                        <td className="px-6 py-4">
                          <span className="text-gray-400 text-sm">
                            {item.timestamp ? formatDate(item.timestamp) : 'Recently'}
                          </span>
                        </td>
                        <td className="px-6 py-4">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center space-x-4 mb-6">
                <div className={`w-16 h-16 rounded-full ${getRandomColor(selectedUser.username)} flex items-center justify-center font-bold text-xl text-white shadow-lg`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-white bg-gray-800 p-3 rounded-lg border border-gray-600">
                      {selectedUser.timestamp ? formatDate(selectedUser.timestamp) : 'Recently'}
                    </div>
                  </div>
                  <div>
